...
def init_running():
    ...
    init_query = "SELECT data6 FROM assy_rh ORDER BY id DESC LIMIT 1"
...
def read_plc_data():
    ...
    # read data (rh)
    select_query_rh = "SELECT * FROM assy1read WHERE id = 5"
    ...
    if sub_record:
        ...
        if len(set_clause) > 0:
            ...
            if not running:
                ...
                complete_query = "UPDATE assy1read SET data9 = 1, contents1 = 20 WHERE id = 6"
...
def check_new_data():
    ...
    if db.is_connected():
        print("Assy DB Conncted... (For checking new INSERT)")
    
    query = "SELECT data1, data2, data3, data4, data5, data6 FROM assy_rh ORDER BY id DESC LIMIT 1"
