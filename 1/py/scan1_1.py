                ...
                if ser.in_waiting > 0:
                    ...
                    for elem in inputs:
                        ...
                        if get_scan_date(data) != "00":
                            ...
                            log_msg = f"[scan1_1][{cur_date} {cur_time}]Send scan signal.\n"
                            log_message(log_msg)
                            print(log_msg)
                            ...
                            log_msg = f"[scan1_1][{cur_date} {cur_time}]Send index({index}).\n"
                            log_message(log_msg)
                            print(log_msg)
                        ...
                        if get_scan_date(data) == "00":
                            ...
                            log_msg = f"[scan1_1][{cur_date} {cur_time}]Initialize monitor.\n"
                            log_message(log_msg)
                            print(log_msg)
